...
<body>
	<div class="best_items">
		...
		<ul class="best_item_list">
			<li class="best_item">
				<a href="#">
					<img class="item_img" src="../assets/img/best1.PNG" /> <br/>
			...
			<li class="best_item">
				<a href="#">
					<img class="item_img" src="../assets/img/best2.PNG"/> <br/>
			...
			<li class="best_item">
				<a href="#">
					<img class="item_img" src="../assets/img/best3.PNG" /> <br/>
					<span class="item_title">상품명</span>
			...
			<li class="best_item">
				<a href="#">
					<img class="item_img" src="../assets/img/best4.PNG" /> <br/>
					<span class="item_title">상품명</span>
					<span class="item_price">00,000 원</span> <br/>
					<div class="clean"></div>
					<span class="item_rating">★★★★☆</span> <br/>
