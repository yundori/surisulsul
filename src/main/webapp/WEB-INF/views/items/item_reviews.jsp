				...
				<table>
					...
					<tr>
						<td class="img_area">
							...
							<img class="review_img" src="${contextPath}/surisulsul/assets/img/items/${item.rev_img}" />
							<%-- </c:if> --%>
						...
						<td class="content_area">
							...
							<div class="content_text">자연스러운 단맛 새콤함이 더 올라오고 복숭아 통조림처럼
								걸쭉한 느낌인데 삼킬때는 맑은 느낌 디저트와인으로 제격입니다. 달큰하고 도수가 낮아 쉽게 접근할 수 있습니다.
								목넘김과 함께 산미가 남아 너무 들척지근하지도 않고 산뜻하게 마실 수 있는 술입니다. 분위기 있는 장소나 가벼운
								홈파티까지 다 어울립니다.</div>
						</td>
					...
					<tr>
						<td class="img_area"><img class="review_img"
							src="${contextPath}/surisulsul/assets/img/no-image.jpg" /></td>
						<td class="content_area">
